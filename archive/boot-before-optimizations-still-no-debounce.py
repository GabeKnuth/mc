...
# Switches bounce when testing with a wire. In-machine, the optocoupler helps,
# but there is either A) Still some bounce or B) Something in code that looks
# like bounce. (I'm 99.9% sure it's actual bounce, but I'm open to anything)

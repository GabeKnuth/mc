...
# to add code or hardware to debounce.
    ...
    coin1.irq(trigger=coin1.IRQ_FALLING, handler=int_handler)
    coin2.irq(trigger=coin2.IRQ_FALLING, handler=int_handler)
    coin3.irq(trigger=coin3.IRQ_FALLING, handler=int_handler)
    coin4.irq(trigger=coin4.IRQ_FALLING, handler=int_handler)
